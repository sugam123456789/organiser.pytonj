...
to_dir ="c:/Users/acer/Desktop/downloded_image"
...
for file_name in list_of_files:
    ...
    if extension == '':
        continue
    if extension in ['.gif', '.png', '.jpg', '.jpeg','.jfif',".mp3","Document_File",".txt","pdf",".docx",".ppt"]:

        path1 = from_dir + '/' + file_name                       # Example path1 : Downloads/ImageName1.jpg        
        path2 = to_dir + '/' + ".mp3"                     # Example path2 : D:/My Files/Image_Files      
